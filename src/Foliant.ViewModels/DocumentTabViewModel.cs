...
public sealed partial class DocumentTabViewModel : ObservableObject, IAsyncDisposable
{
    ...
    private readonly IPdfFormReader? _pdfFormReader;
    ...
    private readonly IPdfPageLabelService? _pageLabelService;
    private readonly IPdfViewerPreferencesService? _viewerPreferencesService;
    private readonly IPdfAttachmentService? _attachmentService;
    private readonly IPdfInsertPagesService? _insertPagesService;
    private readonly IPdfXmpService? _xmpService;
    private readonly IPdfSanitizationService? _sanitizationService;
    private readonly IPdfNamedDestinationService? _namedDestinationService;
    private readonly IPdfFontService? _fontService;
    private readonly IPdfLinkService? _linkService;
    private readonly IPdfCustomPropertiesService? _customPropertiesService;
    private readonly IPdfOcgEditService? _ocgEditService;
    private readonly IPdfOutlineInspector? _outlineInspector;
    private readonly IPdfOutputIntentService? _outputIntentService;
    ...
    public DocumentTabViewModel(
        ...
        IPdfFormReader? pdfFormReader = null,
        ...
        IPdfPageLabelService? pageLabelService = null,
        IPdfViewerPreferencesService? viewerPreferencesService = null,
        IPdfAttachmentService? attachmentService = null,
        IPdfInsertPagesService? insertPagesService = null,
        IPdfXmpService? xmpService = null,
        IPdfSanitizationService? sanitizationService = null,
        IPdfNamedDestinationService? namedDestinationService = null,
        IPdfFontService? fontService = null,
        IPdfLinkService? linkService = null,
        IPdfCustomPropertiesService? customPropertiesService = null,
        IPdfOcgEditService? ocgEditService = null,
        IPdfOutlineInspector? outlineInspector = null,
        IPdfOutputIntentService? outputIntentService = null,
        IPdfPreflightService? preflightService = null)
    {
        ...
        _pageLabelService = pageLabelService;
        _viewerPreferencesService = viewerPreferencesService;
        _attachmentService = attachmentService;
        _insertPagesService = insertPagesService;
        _xmpService = xmpService;
        _sanitizationService = sanitizationService;
        _namedDestinationService = namedDestinationService;
        _fontService = fontService;
        _linkService = linkService;
        _customPropertiesService = customPropertiesService;
        _ocgEditService = ocgEditService;
        _outlineInspector = outlineInspector;
        _outputIntentService = outputIntentService;
