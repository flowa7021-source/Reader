...
- **Аннотации** — выделение (highlight), заметки (note) и рисование от руки (freehand)
  поверх страницы, плюс сайдбар «All Annotations» с экспортом.
- **Управление страницами** — поворот, удаление, перемещение и **drag-and-drop
  переупорядочивание** через полосу миниатюр.
